...
public class ContentTypeRegistry {
	 ...
	 * @return
	 */
	public static Class<? extends ParseData> getHandler(String mimetype) {
	 ...
	 * @return
	 */
	public static boolean register(Class<? extends ParseData> cls) {
		ContentTypeRegistry.getInstance();
		try {
			String[] mimetypes = cls.newInstance().getMimeTypes();
	 ...
	 * @return
	 */
	public static boolean unregister(Class<? extends ParseData> cls) {
	...
	/**
	 * Unregister the {@link ParseData} class that is defined by the given mimetype.
	 * 
	 * @param mimetype
	 * @return
	 */
	public static boolean unregister(String mimetype) {
		ContentTypeRegistry.getInstance();
