...
public class ByteArrayUtils
{
	...
	for ( int i = 0; i < 4; i++ ) {
	    final int offset = ( 3 - i ) * 8;
	    b[i] = (byte) ( ( value >>> offset ) & 0xFF );
	}
	return b;
    }

    public static void putIntInByteArray(final int value, final byte[] buf, final int offset) {
	for ( int i = 0; i < 4; i++ ) {
	    final int valueOffset = ( 3 - i ) * 8;
